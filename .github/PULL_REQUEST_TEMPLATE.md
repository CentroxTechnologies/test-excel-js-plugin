...
<!-- 1-3 sentences. What changed and why. Skip the file-by-file walk; the diff covers that. -->
...
- [ ] Breaking change (requires manifest version bump or schema change)
- [ ] Docs / chores (no runtime impact)
...
<!-- Drag screenshots in if the change is visual. Paste relevant log lines if you hit something interesting. -->
