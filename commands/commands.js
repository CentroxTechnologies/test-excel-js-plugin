...
Office.onReady(() => {
  // No-op. The taskpane opens via the manifest's ShowTaskpane action.
});

// Example pattern for future function-type actions:
//
//   function doSomething(event) {
//     // ... work ...
//     event.completed();
//   }
//   Office.actions.associate("doSomething", doSomething);
